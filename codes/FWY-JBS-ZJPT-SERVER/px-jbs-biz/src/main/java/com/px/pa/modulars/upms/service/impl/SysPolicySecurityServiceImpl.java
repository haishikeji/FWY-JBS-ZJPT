...
import com.px.pa.modulars.upms.mapper.SysPolicySecurityMapper;
import com.px.pa.modulars.upms.service.SysPolicySecurityService;
import com.px.pa.modulars.upms.vo.VerificationCodeVO;
...
public class SysPolicySecurityServiceImpl extends BaseServiceImpl<SysPolicySecurity, SysPolicySecurityMapper> implements SysPolicySecurityService {
    ...
    private final String REGION_POLICY_REGION = "REGION_POLICY_REGION";
    /**
     * 用户的密码错误次数
     */
    ...
    public void clearDefCache(){
        this.cacheChannel.clear(REGION_POLICY_REGION);
    }
    @Override
