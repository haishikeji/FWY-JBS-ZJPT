...
//    @Size(max = 8, message = "锁定时间（分钟）超出长度8的限制")
     ...
     * @return
     */
    public String[] getIpWhiteListArr() {
        if (this.ipWhiteListArr == null && this.ipWhiteList != null) {
            this.ipWhiteList = this.ipWhiteList.trim();
            this.ipWhiteListArr = this.ipWhiteList.split(",");
        }
        return this.ipWhiteListArr;
    }
}
